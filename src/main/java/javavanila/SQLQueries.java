...
public class    SQLQueries {
    ...
    void selector(String table, String... columns) {
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select " + colQuery + " from " + table);


            while (resultSet.next()) {

                for (int i = 0; i < columnRS.length; i++) {
                    System.out.println(columnRS[i] + ": " + resultSet.getString(columnRS[i]));
                }
                System.out.println("------------------------------------------------------------------------------");
            }
            resultSet.close();
